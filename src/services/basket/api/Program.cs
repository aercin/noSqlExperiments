...
builder.Configuration.AddConsul(
                        $"basket/appsettings.{builder.Environment.EnvironmentName}.json",
                        options =>
                        {
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Basket Api", Version = "v1.0" });
    c.SwaggerDoc("v1.1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Basket Api", Version = "v1.1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Basket v1.0 Api");
    });
}
