...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Order Api", Version = "v1.0" });
    c.SwaggerDoc("v1.1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Order Api", Version = "v1.1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Order v1.0 Api");
        c.SwaggerEndpoint("/swagger/v1.1/swagger.json", "Order v1.1 Api");
    });
}
